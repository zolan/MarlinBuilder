...
arduino-cli compile --fqbn STM32:stm32:3dprinter:pnum=MALYANM200_F103CB,upload_method=swdMethod,xserial=generic,usb=CDC,xusb=FS,opt=osstd,rtlib=nano --build-properties build.extra_flags="-DDISABLE_WATCHDOG_INIT" --output /tmp/firmware.bin /tmp/src/marlin/Marlin
